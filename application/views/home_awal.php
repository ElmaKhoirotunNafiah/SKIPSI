			...
			<div class="main-content">
				<div class="container-fluid">
					<div class="panel panel-profile">
						<div class="clearfix">
							<div class="profile">
								<h3 class="text-center"><b>LAPORAN</b></h3>
                                <h4 class="text-center"><b>PERKEMBANGAN KARAKTER SISWA</b></h4>
                                <h4 class="text-center"><b>SDN DABASAH 1 BONDOWOSO</b></h4><br><br><br>
								<!-- AWARDS -->
								<div class="awards">
									<div class="row">
